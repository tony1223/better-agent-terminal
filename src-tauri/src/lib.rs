...
fn app_builder(headless: bool) -> tauri::Builder<tauri::Wry> {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            claude_cmd::claude_scan_mcp_servers,
            claude_cmd::claude_get_mcp_server_status,
            claude_cmd::claude_reconnect_mcp_server,
            claude_cmd::claude_toggle_mcp_server,
            claude_cmd::claude_set_mcp_server_enabled,
